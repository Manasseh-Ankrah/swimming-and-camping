...
<nav class="navbar navbar-expand-lg " style="background-color: green;">
 ...
 <img src="images/caravan1.jpeg" style="height: 60vh;" class="d-block w-100" alt="...">                    <div class="carousel-caption d-none d-md-block bg-header">
                        <h1>Features</h1>
                    </div>
                </div>
            </div>
        ...
        <div class="row">
               ...
               <div class="col-md-4 col-sm-4 col-xs-12 mt-2 ">
                ...
                <div class="card" style="width: 18rem;">
                    ...
                    <div class="card" style="width: 18rem;">
                    <div class="card-body">
                        <h5 class="card-title">Phone Booth</h5>
                    </div>
                </div>
                </div>
                </div>
            ...
            <div class="col-md-4 col-sm-4 col-xs-12 mt-2">
                <div class="card" style="width: 18rem;">
                    <div class="card-body">
                     ...
                     <div class="card" style="width: 18rem;">
                    <div class="card-body">
                        <h5 class="card-title">     Car Park</h5>
                    </div>
                    <div class="card" style="width: 18rem;">
                    <div class="card-body">
                        <h5 class="card-title">Life Guards</h5>
                    </div>
                    <div class="card" style="width: 18rem;">
                    <div class="card-body">
                        <h5 class="card-title">Free Camping Tents</h5>
                    </div>
                </div>
                </div>
                </div>
            ...
            <div class="row">
                <div class="col-md-4 col-sm-6 mt-5">
                    <ul style="margin-left:40px;display: flex;justify-content:flex-start;flex-direction:column;align-items:flex-start">
                        <h6>You are here - <b style="color: yellow;">Features</b></h6>
                    </ul>
                </div>
