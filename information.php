...
<nav class="navbar navbar-expand-lg " style="background-color: green;">
 ...
 <img src="images/swim4.jpeg" style="height: 60vh;" class="d-block w-100" alt="...">                    <div class="carousel-caption d-none d-md-block bg-header">
            ...
            <div class="col-md-4 col-sm-4 col-xs-12 mt-2">
                <div class="card" style="width: 18rem;">
                    <div class="card-body">
                        ...
                        <h5 class="card-title">Pages of Interest</h5>
                        <p class="card-text">1) Pitch types and Availablility  </p>
                        <p class="card-text"> 2)Feature  </p>
                        <p class="card-text"> 2)Locations  </p>
                        <!-- <a href="#" class="btn btn-primary">Link</a> -->
                    </div>
                </div>
            </div>
    ...
    <div class="row">
       ...
       <div class="row">
        <div class="col-md-12 text-center mt-4">
            <h2 style="color:gray">Available Camping and Wild Swimming Locations</h2>
            </div>
    </div>
